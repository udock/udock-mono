...
function default_1(key, options) {
    var val = vue_1.ref(safeParseJSON_1.default(localStorage.getItem(key), options.defaultValue));
        ...
        set: function (value) {
            if (!options.readonly) {
                ...
                vue_1.nextTick(function () {
                    val.value = safeParseJSON_1.default(localStorage.getItem(key), options.defaultValue);
                });
